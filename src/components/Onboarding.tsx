...
export function Onboarding({ onComplete }: OnboardingProps) {
    ...
    return (
        <Page className="bg-(--bg-color)">
            <Navbar
                title={step <= 3 ? `Hapi ${step} nga 3` : 'Mirë se vini'}
                ...
                <div className="w-full max-w-md">
                    ...
                    {step === 1 && (
                        <div className="animate-[fadeIn_0.4s_ease-out]">
                            <BlockTitle large className="text-center mb-2 px-0">Pse dëshiron të mësosh Gjermanisht?</BlockTitle>
                            <Block className="text-center mt-0 mb-8 text-(--text-secondary)">
                            ...
                            <div className="grid grid-cols-2 gap-3 mb-8">
                                {motivationOptions.map(opt => (
                                    <Button
                                        ...
                                        className={`flex flex-col items-center justify-center gap-3 p-5 h-auto rounded-2xl border-2 transition-all duration-200 ${
                                            data.motivation === opt.id 
                    ...
                    {step === 2 && (
                        <div className="animate-[fadeIn_0.4s_ease-out]">
                            <BlockTitle large className="text-center mb-2 px-0">Sa është njohuria jote aktuale?</BlockTitle>
                            <Block className="text-center mt-0 mb-6 text-(--text-secondary)">
                    ...
                    {step === 3 && (
                        <div className="animate-[fadeIn_0.4s_ease-out]">
                            <BlockTitle large className="text-center mb-2 px-0">Sa minuta në ditë mund të mësosh?</BlockTitle>
                            <Block className="text-center mt-0 mb-6 text-(--text-secondary)">
                    ...
                    {step === 5 && (
                        <div className="animate-[fadeIn_0.4s_ease-out]">
                            ...
                            {emailSent ? (
                                <Block strong inset className="bg-green-50 text-green-700 border border-green-200 m-0 mb-6 p-6 flex flex-col items-center text-center gap-4 rounded-2xl">
                                    <Mail size={40} className="text-green-500" />
                                    <div>
                                        <p className="font-bold text-lg mb-1">Kontrolloni emailin tuaj!</p>
                                        <p className="text-sm opacity-80">
                                            Ju dërguam një lidhje hyrjeje në <strong>{emailInput}</strong>.
                                        </p>
                                    </div>
                                </Block>
                            ) : (
                                <div className="flex flex-col gap-4">
                                    <div className="grid grid-cols-1 gap-3">
                                        ...
                                        <Button
                                            ...
                                            disabled={!!authLoading}
                                            className="bg-black text-white flex items-center justify-center gap-3 h-14"
                                        >
                                            {authLoading === 'apple' ? (
                                                <Preloader className="w-5 h-5 text-white" />
                                            ) : (
                                                <Apple size={20} />
                                            )}
                                            Vazhdo me Apple
                                    ...
                                    <List strong inset className="m-0 border-0 shadow-lg rounded-2xl overflow-hidden bg-(--bg-card)">
                                        <ListInput
                                            type="email"
                                    ...
                                    <Button
                                        ...
                                        className="h-14 bg-(--accent-color)"
                                    >
                                        {authLoading === 'email' ? <Preloader className="w-5 h-5 text-white" /> : 'Regjistrohu me Email'}
                                    </Button>
                                </div>
                            )}
